...
public class TransferTransactionCommandHandler(
    ...
    : UnitHandlerBase<TransferTransactionCommand, TransferTransactionViewModel>(provider)
{
    protected override async Task<TransferTransactionViewModel> ExecuteTransactionBodyAsync(TransferTransactionCommand request, CancellationToken cancellationToken)
    {
